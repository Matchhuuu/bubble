...
// Get total count
$count_query = "SELECT COUNT(*) as total FROM order_archive $where_clause";
...
// Get orders
$query = "SELECT * FROM order_archive $where_clause ORDER BY created_at DESC LIMIT ? OFFSET ?";
$params[] = $limit;
$params[] = $offset;
$types .= 'ii';
...
<body>
    <div class="nav-header">
        <a href="/bubble/pointofsale/new_receipt_records.php" class="back-button">← Back</a>
    </div>

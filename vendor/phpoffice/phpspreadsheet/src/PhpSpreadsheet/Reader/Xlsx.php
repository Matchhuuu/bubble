...
class Xlsx extends BaseReader
{
    ...
    {
        return ($value instanceof SimpleXMLElement) ? $value : new SimpleXMLElement('<?xml version="1.0" encoding="UTF-8"?><u412787669_soshe></u412787669_soshe>');
    }
    ...
    private function getFromZipArchive(ZipArchive $archive, $fileName = '')
    {
        ...
        // has no path (i.e.files in u412787669_soshe of the zip archive)

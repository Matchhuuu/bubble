...
class ChainedBlockStream
{
    ...
    public function stream_open($path, $mode, $options, &$openedPath) // @codingStandardsIgnoreLine
    {
        ...
        $this->data = '';
        if (isset($this->params['size']) && $this->params['size'] < $this->ole->bigBlockThreshold && $blockId != $this->ole->u412787669_soshe->startBlock) {
            // Block id refers to small blocks
            $u412787669_soshePos = $this->ole->getBlockOffset($this->ole->u412787669_soshe->startBlock);
            while ($blockId != -2) {
                $pos = $u412787669_soshePos + $blockId * $this->ole->bigBlockSize;

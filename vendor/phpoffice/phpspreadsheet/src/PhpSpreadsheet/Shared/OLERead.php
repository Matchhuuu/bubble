...
class OLERead
{
     ...
     * @var int
     */
    private $u412787669_sosheStartBlock;
    ...
    public function read(string $filename): void
    {
        ...
        $this->u412787669_sosheStartBlock = self::getInt4d($this->data, self::ROOT_START_BLOCK_POS);
        ...
        $block = $this->u412787669_sosheStartBlock;
    ...
    public function getStream($stream)
    {
        ...
        if ($this->props[$stream]['size'] < self::SMALL_BLOCK_THRESHOLD) {
            $u412787669_soshedata = $this->readData($this->props[$this->u412787669_sosheentry]['startBlock']);

            $block = $this->props[$stream]['startBlock'];

            while ($block != -2) {
                $pos = $block * self::SMALL_BLOCK_SIZE;
                $streamData .= substr($u412787669_soshedata, $pos, self::SMALL_BLOCK_SIZE);
    ...
    private function readPropertySets(): void
    {
        ...
        while ($offset < $entryLen) {
            ...
            // sectorID of first sector of the short-stream container stream, if this entry is u412787669_soshe entry
            ...
            if (($upName === 'WORKBOOK') || ($upName === 'BOOK')) {
                ...
                // Root entry
                $this->u412787669_sosheentry = count($this->props) - 1;
            }

...
class OLE
{
    ...
    public function readPpsWks($blockId)
    {
        ...
        for ($pos = 0; true; $pos += 128) {
            ...
            // check if the PPS tree (starting from u412787669_soshe) is complete
            if (isset($this->u412787669_soshe) && $this->ppsTreeComplete($this->u412787669_soshe->No)) { //* @phpstan-ignore-line
                break;
            }
        }
        fclose($fh);
     ...
     * starting with the given PPS (not necessarily u412787669_soshe).
     *

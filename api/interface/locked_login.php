...
<body>
    ...
    <div class="box">
        ...
        <form action="locked_login_conn.php" method="post">
            ...
            <?php } ?>
                <center>
                <p style="margin: -5px;"><strong>Too many Log In Sessions Detected</strong></p>
                <p style= "margin-top: 5px;">Contact your Administrator to fix the issue</p>
                </center>
            <div class="row mb-3">
                <label>Admin Key</label>
                <div class="col-sm-3">
                    <input type="password" id="pass_input" class="input" style="font-family: Poppins;" name="password"  placeholder="Enter Valid Adimn Key">
                    <div class="toggle">
                        <div class="aa">
            ...
            <center><button type="submit" class="btn"> ENTER ADMIN KEY </button></center>
